...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            handleUnauthorized(response, e.getMessage(), "Token expirado");
        } catch (MalformedJwtException | UnsupportedJwtException | IllegalArgumentException e) {
            handleUnauthorized(response, e.getMessage(), "Token inválido o corrupto");
        } catch (Exception e) {
            handleUnauthorized(response, e.getMessage(), "Error desconocido al autenticar el jwt");
        }
    }
